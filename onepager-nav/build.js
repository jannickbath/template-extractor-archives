const { copyFile, createDir, exists, insertStringAfterMatch, stringExistsInFile, readFileContents, createFile, prependStringToFile, appendStringToFile } = require('./helper.js');
